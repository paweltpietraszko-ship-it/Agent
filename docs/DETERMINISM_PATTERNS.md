> Źródło: projekt Elnath Rota ("this project" poniżej = Rota; przypadek T058 to jej historia). Tło filozoficzne dla harnessu tego repo; modele nie muszą tego czytać domyślnie.
